...
<body>
	...
	<div class="container pt-1">
		<div class="d-flex justify-content-center my-5">
			<h1
				style="font-size: 70px; text-align: center;">Editar usuario</h1>
		</div>
	</div>
			...
			<div>
				<form action="editar" method="post">
					<input type="hidden" name="id"
						value="${listaUsuarios.getId()}" />
					<div class="row g-2">
						<div class="col-md">
							<div class="form-floating">
								<input type="text" class="form-control" id="floatingInputGrid"
									placeholder="name@example.com"
									value="${listaUsuarios.getUsuario()}" name="usuario"> <label
						...
						<div class="col-md">
							<div class="form-floating">
								<input type="text" class="form-control" id="floatingInputGrid"
									placeholder="name@example.com" value="${listaUsuarios.getEmail()}"
									name="email"> <label for="floatingInputGrid">Email</label>
							</div>
						</div>
						<div class="col-md">
							<div class="form-floating">
								<input type="text" class="form-control" id="floatingInputGrid"
									placeholder="name@example.com"
									value="${listaUsuarios.getPass()}" name="pass">
						...
						<div class="col-md">
							<div class="form-floating">
								<input type="text" class="form-control" id="floatingInputGrid"
									placeholder="name@example.com"
									value="${listaUsuarios.getPassverificacion()}" name="passverificacion">
								<label for="floatingInputGrid">Contraseña verificada</label>
							</div>
						</div>
					</div>
